...
public class Box2DBodyCreator {
    ...
    public static Fixture createPlayerBody(Box2DBody box2DBody){
        ...
        FixtureDef fixtureDef = getPreparedFixtureDefinition(circleShape, PLAYER_BIT, ENEMY_HEAD_BIT, false);
...
//  la colisión con los bloques fallara. Esta opción es util para personajes controlables.
        ...
        bodyDefinition.position.set(box2DBody.bounds.x /PIXELS_PER_METER, box2DBody.bounds.y /PIXELS_PER_METER);
...
//        no queremos que mario colisione, pues técnicamente este objeto está destruido.
    ...
    public static Body createEnemyBody(Box2DBody box2DBody){
        ...
        FixtureDef fixtureDef = getPreparedFixtureDefinition(circleShape, ENEMY_BIT, PLAYER_BIT, false);
...
//        Deseamos poder acceder a los datos de mi clase goomba o turtle, a la hora de la colisión.
    ...
    public static Body createItemBody(Box2DBody box2DBody){
        ...
        fixtureDef.filter.maskBits = PLAYER_BIT | OBJECT_BIT | GROUND_BIT | COIN_BIT | BRICK_BIT;
